...
load("//xcodeproj/internal/cat:output_files.bzl", "output_groups")
load("//xcodeproj/internal/cat:pbxproj_partials.bzl", "pbxproj_partials")
load("//xcodeproj/internal/cat:xcode_targets.bzl", xcode_targets_module = "xcode_targets")
load(
